...
export const tools: Tool[] = [
  ...
  makeTool({
    ...
    deployment: 'Cloud',
    scriptingLanguages: ['JavaScript', 'C', 'Java'],
    protocols: [
      'HTTP',
      'HTTPS',
      'WebSocket',
  ...
  makeTool({
    ...
    license: 'Commercial',
    pricingModel:
      'Free trial; Basic starts at EUR 89 per month billed annually, with Team and Enterprise plans.',
    deployment: 'Hybrid',
    scriptingLanguages: ['Java', 'Scala', 'Kotlin', 'JavaScript', 'TypeScript'],
    protocols: ['HTTP', 'HTTPS', 'WebSocket', 'SSE', 'JMS', 'MQTT', 'gRPC'],
    osSupport: ['Browser'],
    firstReleased: 2023,
    status: 'Active',
    cloudBased: true,
  ...
  makeTool({
    ...
    category: 'Cloud Load Testing',
    license: 'Freemium',
    pricingModel: 'Free tier; Pro is USD 99.95 per month.',
    deployment: 'Cloud',
